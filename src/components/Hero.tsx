...
export function Hero() {
  return (
    <section className="relative left-1/2 right-1/2 ml-[-50vw] mr-[-50vw] w-screen overflow-visible pt-1 pb-10 md:-mt-16 md:min-h-[100svh] md:pt-2 md:pb-14 lg:-mt-20">
      ...
      <div className="relative z-10 mx-auto grid min-h-[100svh] w-full max-w-[1440px] items-start gap-8 px-6 pt-8 md:gap-14 md:pt-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-start lg:px-10 lg:pt-14">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          className="max-w-3xl space-y-6 md:space-y-8 lg:-mt-24"
        >
        ...
        <motion.div
          ...
          className="relative mx-auto mt-8 flex h-[27rem] w-full min-w-0 max-w-[36rem] items-center justify-center overflow-visible px-0 md:mt-12 md:h-[38rem] md:max-w-[40rem] lg:mt-28 lg:h-[46rem] lg:max-w-[44rem]"
        >
