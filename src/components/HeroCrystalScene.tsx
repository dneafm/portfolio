...
export function HeroCrystalScene() {
  return (
    <div className="absolute -inset-x-[15%] -top-[10%] -bottom-[24%] z-10 origin-center scale-[0.48] overflow-visible saturate-[1.34] md:-inset-x-[8%] md:-top-[14%] md:-bottom-[32%] md:scale-[0.5] md:overflow-visible md:saturate-[1.38] lg:-inset-x-[24%] lg:-top-[16%] lg:-bottom-[44%] lg:scale-[0.56] lg:saturate-[1.42]">
      <motion.div
